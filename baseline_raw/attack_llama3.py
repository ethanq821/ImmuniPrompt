...
def attack_llama3(datas,test_model,output_file):
...
def main():
    ...
    success_file = '/data/jiani/prompt_new/test_origin/result/llama3/1_t.jsonl'
    output_file = '/data/jiani/prompt_new/test_origin/result/llama3/1.jsonl'
    ...
    print('---------------------attack start-------------------------')
    start = time.time()
    attack_llama3(datas,test_model,output_file)
    ...
    print(f'attack time in llama3 is {end - start}')
