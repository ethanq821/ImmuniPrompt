...
def main():
    ...
    test_model = model.vicuna7b

    input_file = f'/data/jiani/prompt_new/dataset/jailbreak/jailbreak_prompts_question14.jsonl'
    success_file = '/data/jiani/prompt_new/test_origin/result/vicuna7b/1_t.jsonl'
    output_file = '/data/jiani/prompt_new/test_origin/result/vicuna7b/1.jsonl'
    ...
    print(f'attack result in vicuna7b')
    result = read_jsonl_file(output_file)
    result_statistics(result)

    print(f'attack time in vicuna7b is {end - start}')
