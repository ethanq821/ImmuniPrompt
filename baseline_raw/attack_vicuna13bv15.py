...
def main():
    ...
    test_model = model.vicuna13bv15

    input_file = f'/data/jiani/prompt_new/dataset/jailbreak/jailbreak_prompts_question14.jsonl'
    success_file = '/data/jiani/prompt_new/test_origin/result/vicuna13bv15/1_t.jsonl'
    output_file = '/data/jiani/prompt_new/test_origin/result/vicuna13bv15/1.jsonl'
    ...
    print(f'attack result in vicuna13bv15')
    result = read_jsonl_file(output_file)
    result_statistics(result)

    print(f'attack time in vicuna13bv15 is {end - start}')
