...
def main():
    ...
    success_file = '/data/jiani/prompt_new/test_origin/result/mistral/1_t.jsonl'
    output_file = '/data/jiani/prompt_new/test_origin/result/mistral/1.jsonl'
    ...
    #print(f'attack time in mistral: {end - start}')
