...
def main():
    ...
    success_file = '/data/jiani/prompt_new/test_origin/result/qwenturbe/1_t.jsonl'
    output_file = '/data/jiani/prompt_new/test_origin/result/qwenturbe/1.jsonl'
   ...
   # print(f'attack time in {str(test_model.__name__)} is {end - start}')
