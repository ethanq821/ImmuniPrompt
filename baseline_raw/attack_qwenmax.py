...
def main():
    ...
    success_file = '/data/jiani/prompt_new/test_origin/result/qwenmax/1_t.jsonl'
    output_file = '/data/jiani/prompt_new/test_origin/result/qwenmax/1.jsonl'
    ...
    print(f'attack time in qmax: {end - start}')
    print('---------------------attack over-------------------------')
