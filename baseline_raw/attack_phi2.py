...
def main():
    ...
    test_model = model.phi2

    input_file = f'/data/jiani/prompt_new/dataset/jailbreak/jailbreak_prompts_question14.jsonl'
    success_file = '/data/jiani/prompt_new/test_origin/result/phi2/1_t.jsonl'
    output_file = '/data/jiani/prompt_new/test_origin/result/phi2/1.jsonl'
    ...
    print(f'attack result in phi2')
    result = read_jsonl_file(output_file)
    result_statistics(result)

    print(f'attack time in phi2 is {end - start}')
