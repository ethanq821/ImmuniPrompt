...
def main():
    ...
    success_file = '/data/jiani/prompt_new/test_origin/result/gpt4o/1_t.jsonl'
    output_file = '/data/jiani/prompt_new/test_origin/result/gpt4o/1.jsonl'
