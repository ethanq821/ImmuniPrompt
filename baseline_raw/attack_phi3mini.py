...
def main():
    ...
    test_model = model.phi3_mini

    input_file = f'/data/jiani/prompt_new/dataset/jailbreak/jailbreak_prompts_question14.jsonl'
    success_file = '/data/jiani/prompt_new/test_origin/result/phi3mini/1_t.jsonl'
    output_file = '/data/jiani/prompt_new/test_origin/result/phi3mini/1.jsonl'
    ...
    print(f'attack result in phi3_mini')
    result = read_jsonl_file(output_file)
    result_statistics(result)

    print(f'attack time in phi3_mini is {end - start}')
