...
def main():
    ...
    test_model = model.qwen7b

    input_file = f'/data/jiani/prompt_new/dataset/jailbreak/jailbreak_prompts_question14.jsonl'
    success_file = '/data/jiani/prompt_new/test_origin/result/qwen7b/1_t.jsonl'
    output_file = '/data/jiani/prompt_new/test_origin/result/qwen7b/1.jsonl'
