...
def main():
    ...
    success_file = '/data/jiani/prompt_new/test_origin/result/gpt3.5/1_t.jsonl'
    output_file = '/data/jiani/prompt_new/test_origin/result/gpt3.5/1.jsonl'
