...
def main():
    ...
    test_model = model.mistralv03

    input_file = f'/data/jiani/prompt_new/dataset/jailbreak/jailbreak_prompts_question14.jsonl'
    success_file = '/data/jiani/prompt_new/test_origin/result/mistralv03/1_t.jsonl'
    output_file = '/data/jiani/prompt_new/test_origin/result/mistralv03/1.jsonl'
    ...
    print(f'attack result in mistralv03')
    result = read_jsonl_file(output_file)
    result_statistics(result)

    print(f'attack time in mistralv03 is {end - start}')
