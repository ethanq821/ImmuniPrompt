...
def main():
    ...
    test_model = model.gemma_chat

    input_file = f'/data/jiani/prompt_new/dataset/jailbreak/jailbreak_prompts_question14.jsonl'
    success_file = '/data/jiani/prompt_new/test_origin/result/gemma/1_t.jsonl'
    output_file = '/data/jiani/prompt_new/test_origin/result/gemma/1.jsonl'
    ...
    print(f'attack result in gemma')
    result = read_jsonl_file(output_file)
    result_statistics(result)

    print(f'attack time in gemma is {end - start}')
