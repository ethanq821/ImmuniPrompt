...
def main():
    ...
    success_file = '/data/jiani/prompt_new/test_origin/result/qwenplus/1_t.jsonl'
    output_file = '/data/jiani/prompt_new/test_origin/result/qwenplus/1.jsonl'
    ...
    #print(f'attack time in qp: {end - start}')
