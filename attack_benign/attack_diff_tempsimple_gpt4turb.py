...
def main():
    ...
    filedata = load_jsonl('/data/jiani/prompt_new/dataset/benign/benign10000.jsonl')
    for model_names in model_list:
        print(model_names)
        prompts_with_resp = '/data/jiani/prompt_new/llamaguard_judge/attack_benign/'+model_names+'/26512_simple.jsonl'
