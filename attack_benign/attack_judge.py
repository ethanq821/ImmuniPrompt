...
def main():
    ...
    model_list = ['gpt35', 'llama2'] # done
    #model_list = ['qwenmax', 'qwenturbe']
    #model_list = ['']

    
    checkpoint_path = '/data/jiani/prompt_new/llamaguard_judge/attack_benign/checkpoint_main_'+model_list[0]+'.json'
    ...
    for subdir_index, subdir in enumerate(subdirectories[start_subdir_index:], start=start_subdir_index):
        ...
        try:
            if(subdir in model_list):
                ...
                prompts_with_resp = '/data/jiani/prompt_new/llamaguard_judge/attack_benign/'+subdir+'/26512_simple.jsonl'
                ...
                with open('/data/jiani/prompt_new/llamaguard_judge/attack_benign/Attack_Success_Rate_ALL.jsonl', 'a') as f:
