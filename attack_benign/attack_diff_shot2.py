...
def main():
    ...
    for model_names in model_list:
        print(model_names)
        prompts_with_resp = '/data/root/prompt_new/llamaguard_judge/attack_benign/'+model_names+'/2000_raw.jsonl'
    ...
    #             prompts_with_resp = '/data/root/prompt_new/llamaguard_judge/attack_jailbreak/'+subdir+'_full_shot2.jsonl'
    #             file_path = prompts_with_resp
    #             output_path = os.path.join('/data/root/prompt_new/llamaguard_judge/attack_jailbreak/',subdir+'_full_shot2_judge.jsonl')
