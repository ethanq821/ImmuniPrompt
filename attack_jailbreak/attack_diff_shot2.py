...
def test_model(prompt, target_model, sys_prompt="NULL"):
    ...
    if(target_model == 'gpt4o'):
        ...
        response, loadtime, runtime = model.llama2(prompt, sys_prompt)
...
def main():
    ...
    #model_list =  ['qwenplus','qwenturbe']                          # done
    ...
    for model_names in model_list:
        ...
        for data in filedata:
            ...
            prompt = data['prompt']
            response, load_time, run_time = test_model(goal_hijack+prompt, 'llama2', system_prompt)
    ...
    #             prompts_with_resp = '/data/jiani/prompt_new/llamaguard_judge/attack_jailbreak/'+subdir+'_full_shot2.jsonl'
    #             file_path = prompts_with_resp
    #             output_path = os.path.join('/data/jiani/prompt_new/llamaguard_judge/attack_jailbreak/',subdir+'_full_shot2_judge.jsonl')
