...
def main():
    ...
    for model_names in model_list:
        ...
        for data in filedata:
            ...
            with open('/data/jiani/prompt_new/llamaguard_judge/attack_jailbreak/'+model_names+'_nobm.jsonl', 'a') as f:
    ...
    for subdir_index, subdir in enumerate(subdirectories[start_subdir_index:], start=start_subdir_index):
        try:
            if(subdir in model_list):
                ...
                file_path = '/data/jiani/prompt_new/llamaguard_judge/attack_jailbreak/'+subdir+'_nobm.jsonl'
                output_path = os.path.join('/data/jiani/prompt_new/llamaguard_judge/attack_jailbreak/',subdir+'nobm_judge.jsonl')
