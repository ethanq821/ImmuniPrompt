...
def main():
    ...
    #     print(model_names)
    #     prompts_with_resp = '/data/jiani/prompt_new/llamaguard_judge/attack_jailbreak/'+model_names+'_newfull.jsonl'
    ...
    for subdir_index, subdir in enumerate(subdirectories[start_subdir_index:], start=start_subdir_index):
        ...
        try:
            if(subdir in model_list):
                ...
                prompts_with_resp = '/data/jiani/prompt_new/llamaguard_judge/attack_jailbreak/'+subdir+'_newfull.jsonl'
