    ...
    for subdir_index, subdir in enumerate(subdirectories[start_subdir_index:], start=start_subdir_index):
        ...
        try:
            if(subdir in model_list):
                ...
                prompts_with_resp = '/data/jiani/prompt_new/llamaguard_judge/attack_jailbreak/'+subdir+'/goal_hijack.jsonl'
                file_path = prompts_with_resp
                output_path = os.path.join('/data/jiani/prompt_new/llamaguard_judge/attack_jailbreak/'+subdir+'/goal_hijack_judge.jsonl')
                ...
                with open('/data/jiani/prompt_new/llamaguard_judge/attack_jailbreak/Attack_Success_Rate_ALL.jsonl', 'a') as f:
