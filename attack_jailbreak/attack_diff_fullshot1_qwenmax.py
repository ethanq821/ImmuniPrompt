...
def main():
    ...
    for model_names in model_list:
        ...
        for data in filedata:
            ...
            response = test_model(goal_hijack+prompt, model_names, system_prompt)
            end_time = time.time()
            data['response'] = response
            data['single_run_time'] = end_time - start_time
            sum_attacktime += (end_time - start_time)
    ...
    #             prompts_with_resp = '/data/jiani/prompt_new/llamaguard_judge/attack_jailbreak/'+subdir+'/26512_simple.jsonl'
    #             file_path = prompts_with_resp
    #             output_path = os.path.join('/data/jiani/prompt_new/llamaguard_judge/attack_jailbreak/',subdir+'/26512_simple_judge.jsonl')
