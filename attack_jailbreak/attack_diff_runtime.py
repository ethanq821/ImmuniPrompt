...
def main():
    ...
    for model_names in model_list:
        print(model_names)
        prompts_with_resp = '/data/jiani/prompt_new/llamaguard_judge/attack_jailbreak/'+model_names+'/overhead.jsonl'
        ...
        with open("/data/jiani/prompt_new/llamaguard_judge/attack_jailbreak/raw_runtime.jsonl", 'a') as f:
