...
safes = []
with open('/data/jiani/prompt_new/test_llamaguard/llama_guard2_query_output14.jsonl', 'r') as f:
    for line in f:
...
start = time.time()
with open('/data/jiani/prompt_new/test_llamaguard/attack_mistral.jsonl', "a", encoding='utf-8') as file:
    for safe_prompt in safes:
            response = test_model(safe_prompt, 'mistral')
