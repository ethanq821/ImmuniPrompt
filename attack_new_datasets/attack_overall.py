...
def main():
    ...
    for model_names in model_list:
        print(model_names)
        prompts_with_resp = '/data/root/prompt_new/llamaguard_judge/attack_new_dataset/overall/'+model_names+'.jsonl'
        ...
        with open("/data/root/prompt_new/llamaguard_judge/attack_new_dataset/overall_runtime.jsonl", 'a') as f:
    ...
    for subdir_index, subdir in enumerate(subdirectories[start_subdir_index:], start=start_subdir_index):
        ...
        try:
            if(subdir in model_list):
                ...
                prompts_with_resp = '/data/root/prompt_new/llamaguard_judge/attack_new_dataset/overall/'+subdir+'.jsonl'
                file_path = prompts_with_resp
                output_path = os.path.join('/data/root/prompt_new/llamaguard_judge/attack_new_dataset/overall/',subdir+'_judge.jsonl')
                ...
                with open('/data/root/prompt_new/llamaguard_judge/attack_new_dataset/Overall_ASR.jsonl', 'a') as f:
