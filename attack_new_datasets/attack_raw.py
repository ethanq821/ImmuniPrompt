...
def main():
    ...
    filedata = load_jsonl('/data/root/prompt_new/dataset/new/output_all.jsonl')
    # for model_names in model_list:
    #     print(model_names)
    #     prompts_with_resp = '/data/root/prompt_new/llamaguard_judge/attack_new_dataset/raw/'+model_names+'.jsonl'
    ...
    #         )
    #     with open("/data/root/prompt_new/llamaguard_judge/attack_new_dataset/raw_runtime.jsonl", 'a') as f:
    ...
    for subdir_index, subdir in enumerate(subdirectories[start_subdir_index:], start=start_subdir_index):
        ...
        try:
            if(subdir in model_list):
                ...
                prompts_with_resp = '/data/root/prompt_new/llamaguard_judge/attack_new_dataset/raw/'+subdir+'.jsonl'
                file_path = prompts_with_resp
                output_path = os.path.join('/data/root/prompt_new/llamaguard_judge/attack_new_dataset/raw/',subdir+'_judge.jsonl')
                ...
                with open('/data/root/prompt_new/llamaguard_judge/attack_new_dataset/Raw_ASR.jsonl', 'a') as f:
